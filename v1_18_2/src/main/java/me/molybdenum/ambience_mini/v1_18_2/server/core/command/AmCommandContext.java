package me.molybdenum.ambience_mini.v1_18_2.server.core.command;
...
public class AmCommandContext extends BaseCommandContext
{
    ...
    private Component ofText(Text text) {
        return text.isLiteral
                ? new TextComponent(text.base)
                : new TranslatableComponent(text.base, Arrays.stream(text.args).toArray());
    }
}
