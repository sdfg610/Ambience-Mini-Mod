package me.molybdenum.ambience_mini.v1_18_2.client.core.render.area;
...
public class AreaScreenSymbiote extends BaseAreaScreenSymbiote<EditBox, Checkbox, Button>
{
    ...
    protected EditBox makeTextBox(Vector2i size, String content) {
        EditBox editBox = new EditBox(mc.font, 0, 0, size.x(), size.y(), TextComponent.EMPTY);
    ...
    protected Checkbox makeCheckBox(boolean selected, String label) {
        return new Checkbox(0, 0, CHECKBOX_SIDE_LENGTH, CHECKBOX_SIDE_LENGTH, new TextComponent(label), selected);
    }
