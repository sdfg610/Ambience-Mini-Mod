...
public class PlayerState extends BasePlayerState<BlockPos, Vec3, LocalPlayer> {
    ...
    public BlockPos eyeBlockPos() {
        return cachedPlayer == null ? null : cachedPlayer.eyeBlockPosition();
    }
    ...
    public Boolean fishingHookInWater() {
        return cachedPlayer == null ? null : (cachedPlayer.fishing != null && (cachedPlayer.fishing.isOpenWaterFishing() || cachedPlayer.fishing.isInWater()));
    }
