...
package javazoom.jlayer_am_custom.audio;

import javax.sound.sampled.*;

import javazoom.jlayer_am_custom.decoder.Decoder;
import javazoom.jlayer_am_custom.decoder.JavaLayerException;
...
public class JavaSoundAudioDevice extends AudioDeviceBase
{
	...
	public void setGain(float gain) {
		if (source==null)
			...
			((FloatControl)source.getControl(FloatControl.Type.MASTER_GAIN)).setValue(gain);
	}
