...
public class VorbisCommentTag extends AbstractTag
{
    ...
    static
    {
        ...
        tagFieldToOggField.put(FieldKey.ENCODER, VENDOR);     //Known as vendor in VorbisComment
    ...
    public static final String DEFAULT_VENDOR = "org/jaudiotagger";
    ...
    {
        if (field.getId().equals(VENDOR.getFieldName()))
        {
