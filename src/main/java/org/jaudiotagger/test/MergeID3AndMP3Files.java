...
public class MergeID3AndMP3Files
{
    ...
    private void scanSingleDir(final File fromDir, final File toDir, final File mp3File)
    {
        ...
        final File[] audioFiles = fromDir.listFiles(new MP3FileFilter());
        ...
        final File[] audioFileDirs = fromDir.listFiles(new DirFilter());
    ...
    final class MP3FileFilter extends javax.swing.filechooser.FileFilter implements FileFilter
    {
